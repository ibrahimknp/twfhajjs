...
public class CaseTypes_Master_Screen extends Composite implements PopupMain,MyRefresh_Impl{
	...
	private static CaseTypes_Master_Screen instance;
	public static CaseTypes_Master_Screen getInstance()
	{
		if(instance == null)
			instance = new CaseTypes_Master_Screen();
		
		return instance;
	}
	
	public CaseTypes_Master_Screen() {
		// TODO Auto-generated constructor stub
		dialog = new MyDialogBox("Case Types Master","CaseTypes_Master_Screen");
		dialog.registerDestroy(this);
		MyVerticalPanel vMain = new MyVerticalPanel();
		vMain.setSize(670, 150);
		
		
		txtNameLa = new MyTextBox(350, 50, "Type Name (LA)", false);
		txtNameAr = new MyTextBox(350, 50, "Type Name (AR)", false);
